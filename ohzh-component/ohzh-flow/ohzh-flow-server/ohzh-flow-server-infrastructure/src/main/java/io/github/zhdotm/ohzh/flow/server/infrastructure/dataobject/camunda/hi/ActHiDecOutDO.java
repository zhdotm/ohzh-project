...
/**
 * @TableName ACT_HI_DEC_OUT
 */
@TableName(value = "ACT_HI_DEC_OUT")
@Data
public class ActHiDecOutDO implements Serializable {
     ...
     *
     */
    @TableField(value = "RULE_ID_")
    private String ruleId;
    /**
     *
     */
    @TableField(value = "RULE_ORDER_")
