 ...
 */
@Slf4j
@Condition(stateMachineId = "machine_id_001", transitionId = "transition_003")
@Component
public class Condition003 implements ICondition {
    @Override
    public Boolean isAllowed(IEvent event) {
        log.info("条件003接收到事件: {}, {}", event.getId(), event.getPayload());
