 ...
 */
@Slf4j
@Action(stateMachineId = "machine_id_001", transitionId = "transition_005")
@Component
public class Action005 implements IAction {

    @Override
    public void onEvent(IEvent event) {
        log.info("动作005接受到事件: {}, {}", event.getId(), event.getPayload());
    }
