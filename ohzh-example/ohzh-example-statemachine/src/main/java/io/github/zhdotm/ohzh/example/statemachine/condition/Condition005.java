 ...
 */
@Slf4j
@Condition(stateMachineId = "machine_id_001", transitionId = "transition_005")
@Component
public class Condition005 implements ICondition {
    @Override
    public Boolean isAllowed(IEvent event) {
        log.info("条件005接收到事件: {}, {}", event.getId(), event.getPayload());
